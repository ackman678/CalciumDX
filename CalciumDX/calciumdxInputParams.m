if strcmp(get(det_view,'enable'),'off')
    ...
    if islocal == 0
        ...
        btclear = uicontrol(fig,'Style','pushbutton','Units','normalized','String','Clear all','Position',[.02 .96 .08 0.03],'FontSize',9,...
            'Callback','cn{num} = []; calciumdxDrawCells;');
        %This button will import contour data from an existing .mat file.
        btimport = uicontrol(fig,'Style','pushbutton','Units','normalized','String','Import Contours','Position',[.02 .92 .08 0.03],'FontSize',9,...
        ...
        btalign = uicontrol(fig,'Style','pushbutton','Units','normalized','String','Align All','Position',[.02 .88 .08 0.03],'FontSize',9,...
        ...
        btalign2 = uicontrol(fig,'Style','pushbutton','Units','normalized','String','Align Single','Position',[.02 .84 .08 0.03],'FontSize',9,...
        ...
        btalign3 = uicontrol(fig,'Style','pushbutton','Units','normalized','String','Align All + Coords','Position',[.02 .80 .08 0.03],'FontSize',9,'Callback','calciumdxRealignCoordsContours');
        %---END new 07/19/09
