...
% See also:
% batchFetchStimResponseProps, myMakeMultiPETHplot, myPETH, getPETH, myFrameTriggerDetect, getStimParams, batchmakeStimParamsWaveonsets, calciumdx, calciumdxevents, calciumdxDetectWaves
