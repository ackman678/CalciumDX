...
for locationIndex = locationMarkers
    ...
    region = calciumdxDetectWavesRefineByLocation(region,locationIndex,ntFilt);
end
end

function    region = calciumdxDetectWavesRefineByLocation(region,locationIndex,ntFilt)
...
disp(['wave onsetsonsets: ' num2str(idx1)])
