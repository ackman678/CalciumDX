function h=myPlotRasterHist(fnm,region,stimulusParams,rmBaseline,dur,corrvals)
...
% plot(corrvals(:,1)); title('gaussian6 xcorr2 y-displacement')
% plot(corrvals(:,1)); title('procrustes dissimilarity measure')
% plot(corrvals(:,1)); title('normxcorr2 template fr8-10'); grid on
% plot(corrvals(:,1)); title('normxcorr2 template fr257-264'); grid on
% plot(corrvals(:,1)); title('normxcorr2 template fr874-881'); grid on
plot(corrvals(:,1)); title('template3'); grid on
ylabel('Frame corr displacement value')
