function [stn, decpt, sd, sd2, sd3, nonfilt, hannfilterorder] = calciumdxdettrial(x,region,hannfilterorder)
% cnum=353; %testing
...
if nargin < 3 || isempty(hannfilterorder); hannfilterorder = 2; end
...
% y = myfilter(x,2); %if you don't want to use high pass baseline correction.
